...
const Navbar = () => {
    return(
        <div className="h-16 px-4 bg-slate-50/80 backdrop-blur-sm flex items-center justify-center text-base text-slate-800 sticky top-0 z-10 shadow-sm">
            <div className="flex space-x-6 items-center">
                ...
                <div className="cursor-pointer flex items-center text-slate-800 hover:text-slate-600 transition-transform duration-200 hover:scale-110">
