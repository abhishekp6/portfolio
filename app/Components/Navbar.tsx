...
const Navbar = () => {
    return(
        <div className="h-16 px-4 bg-slate-50 flex items-center justify-center text-lg opacity-75 sticky top-0">
            <div className="flex space-x-6">
                ...
                <div className="cursor-pointer"><Link href="https://github.com/abhishekp6" target="_blank">
