        ...
        <div className="h-full mx-24">
            ...
            <div id="projects" className="mt-24">
                ...
                <div className="flex flex-wrap space-x-2 space-y-2">
                    <div></div>
                    <div className="border-solid border w-full sm:w-auto p-1 rounded-md border-neutral-400 flex-1">
                    ...
                    <div className="border-solid border rounded-md border-neutral-400 w-full sm:w-auto p-1 rounded-md flex-1">
